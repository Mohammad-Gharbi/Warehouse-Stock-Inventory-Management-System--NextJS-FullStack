  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {children || (
          <Button className="h-10 font-semibold inline-flex items-center justify-center rounded-xl border border-violet-400/30 dark:border-violet-400/30 bg-card text-white shadow-sm backdrop-blur-sm transition duration-200 hover:border-violet-300/50 dark:hover:border-violet-300/50 ">
            + Create Order
          </Button>
        )}
      </DialogTrigger>
      <DialogContent
        className="p-4 sm:p-7 sm:px-8 poppins max-h-[90vh] overflow-y-auto border-violet-400/30 dark:border-violet-400/30 shadow-sm "
          ...
          <FormProvider {...editFormMethods}>
            <form onSubmit={editFormMethods.handleSubmit(handleUpdateOrder)}>
                ...
                currentStatus === "delivered" ? (
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      type="date"
                      className="h-11 w-full rounded-md border border-violet-400/30 dark:border-white/20 bg-white/10 dark:bg-white/5 px-3 py-2 text-white placeholder:text-white/40 focus:border-violet-400 focus:ring-violet-500/50 shadow-sm"
                      defaultValue={
              ...
              <DialogFooter className="mt-9 mb-4 flex flex-col sm:flex-row items-center gap-4">
                ...
                <Button
                  type="submit"
                  className="h-11 w-full sm:w-auto px-11 inline-flex items-center justify-center rounded-xl border border-violet-400/30 dark:border-violet-400/30 bg-card text-white shadow-sm backdrop-blur-sm transition duration-200 hover:border-violet-300/40 dark:hover:border-violet-300/40 "
                  disabled={isUpdating}
                >
                          ...
                          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Input
                                ...
                                className="h-11 border-violet-400/30 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:border-violet-400 focus-visible:border-violet-400 focus:ring-violet-500/50 focus-visible:ring-violet-500/50 shadow-sm [&:invalid]:border-violet-400/30 [&:invalid]:focus:border-violet-400 [&:invalid]:focus-visible:border-violet-400"
                              />
