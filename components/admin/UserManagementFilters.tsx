    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
      ...
      <div className="flex items-center gap-4 flex-wrap sm:flex-nowrap">
        <FilterDropdown
          ...
          label="Role"
          icon={Users}
          triggerClassName="h-10 rounded-[28px] border border-rose-400/30 dark:border-rose-400/30 bg-card text-gray-700 dark:text-white shadow-sm backdrop-blur-sm transition duration-200 hover:border-rose-300/40 dark:hover:border-rose-300/40 gap-2"
        />
      </div>
    </div>
  );
