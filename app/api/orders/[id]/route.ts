...
export async function GET(
  ...
  try {
    ...
    const transformedOrder = {
      ...
      receptionConfirmedAt: order.receptionConfirmedAt?.toISOString() || null,
      invoiceDocumentUrl: order.invoiceDocumentUrl ?? null,
      invoiceDocumentFileId: order.invoiceDocumentFileId ?? null,
      invoiceDocumentFileName: order.invoiceDocumentFileName ?? null,
      invoiceDocumentUploadedAt: order.invoiceDocumentUploadedAt?.toISOString() || null,
      virementDocumentUrl: order.virementDocumentUrl ?? null,
      virementDocumentFileId: order.virementDocumentFileId ?? null,
      virementDocumentFileName: order.virementDocumentFileName ?? null,
      virementDocumentUploadedAt: order.virementDocumentUploadedAt?.toISOString() || null,
      chequeReadySignalledAt: order.chequeReadySignalledAt?.toISOString() || null,
